...
import cartIcon from "./../../assets/icons/icons-header/cart.svg"
import userIcon from "./../../assets/icons/icons-header/user.svg"
import { Link } from "react-router-dom";
import { useAppSelector } from "../../hooks/redux-hooks";

const Header = () => {

    const links = ["Plant pots", "Ceramics", "Tables", "Chairs", "Crockery", "Tableware", "Cutlery"]
    ...
    return (
        <div className={cl.header}>
            <div className={cl.header__container}>
                ...
                <div className={cl.header__rowTop}>
                    <div className={cl.header__search}>
                        <svg className={cl.header__searchSVG} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className={cl.header__burgerSVG} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={cl.header__logo}>
                        <Link to="/" className={cl.header__logoLink}><p>Avion</p></Link>
                    </div>
                    <div className={cl.header__user}>

                        <div className={ cl.cart }>
                            <div className={ cart.length ? `${ cl.cartAmount }` : "" }>{ cart.length ? cart.length : "" }</div>
                            <Link to="/cart">
                                <svg className={cl.cartIcon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="16" height="16" fill="white" />
                ...
                <div className={cl.header__divider}></div>

                <div className={cl.header__rowBottom}>
                    <div className={cl.header__nav}>
                        <ul className={cl.header__navList}>
                            {/* <li className={cl.header__navLink}><a href="#">Plant pots</a></li>
                            <li className={cl.header__navLink}><a href="#">Ceramics</a></li>
                            <li className={cl.header__navLink}><a href="#">Tables</a></li>
                            <li className={cl.header__navLink}><a href="#">Chairs</a></li>
                            <li className={cl.header__navLink}><a href="#">Crockery</a></li>
                            <li className={cl.header__navLink}><a href="#">Tableware</a></li>
                            <li className={cl.header__navLink}><a href="#">Cutlery</a></li> */}
                            {Array.from(new Set(items.map(item => item.category))).map(el => (
                                <li key={el} className={cl.header__navLink}><Link to={`/${el}`}>{el}</Link></li>
                            ))}
                        </ul>
                    </div>
                </div>
